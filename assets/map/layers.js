...
export function installMapSourcesAndLayers({ map, addPmtilesSource, COLORS, ZONING_FILL_COLOR, contourDemSource, saleGeoJson, salePointGeoJson, unmappedGeoJson }) {
  ...
  map.addLayer({ id: 'wildfire-perimeters-lines', type: 'line', source: 'wildfire_perimeters', 'source-layer': 'wildfire_perimeters', minzoom: 6, layout: { visibility: 'none', 'line-join': 'round' }, paint: { 'line-color': '#bd7d22', 'line-width': ['interpolate', ['linear'], ['zoom'], 7, 0.8, 13, 1.7], 'line-opacity': 0.72 } });
