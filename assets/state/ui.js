...
export function createSearchController({ map, maplibregl, detailsElement, featureCenter, filteredMappedListings, filteredUnmappedListings, normalizeSearch, getApnIndex, setSearchQuery, updateSales, selectApn, showParcelDetails }) {
