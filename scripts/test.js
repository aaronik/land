...
if (!failures.length) {
  ...
  if (!html.includes('Find an APN, address, or listing') || !listings.includes('recordMatchesSearch') || !listings.includes('filteredMappedListings') || !listings.includes('filteredUnmappedListings') || !app.includes("addEventListener('search', findListings)")) failures.push('Expanded address and listing search is missing');
