...
if (!failures.length) {
  ...
  if (!parcelDetails.includes('Look up assessment on ParcelQuest') || !parcelDetails.includes('Parcel Map') || !parcelDetails.includes('Siskiyou County Assessor')) failures.push('County assessment and external owner lookup actions are missing');
