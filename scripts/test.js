...
if (!failures.length) {
  ...
  if (!app.includes("target.textContent = ` · ${zoning") || app.includes('Land use ${escapeHtml(p.LandUse1)')) failures.push('Parcel details do not replace numeric land use with zoning');
