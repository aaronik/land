...
const LAYERS = {
  ...
  landslides: {
    name: 'USGS historical landslides and debris flows',
    url: 'https://services.arcgis.com/v01gqwM5QqNysAAi/arcgis/rest/services/US_Landslide_point_v2/FeatureServer/11',
    bbox: SISKIYOU_BBOX,
